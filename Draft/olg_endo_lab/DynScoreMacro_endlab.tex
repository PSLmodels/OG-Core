...
\section{Characteristics of exogenous population growth assumptions}\label{AppPopGrowth}
  ...
  \begin{figure}[htbp]\centering \captionsetup{width=4.0in}
    ...
    \fbox{\resizebox{4.0in}{2.8in}{\includegraphics{images/InitPopDist.png}}}
  \end{figure}

  \begin{figure}[htbp]\centering \captionsetup{width=4.0in}
    \caption{\label{FigFertRates}\textbf{Fertility rates $f_s$ for $S=60$}}
    \fbox{\resizebox{4.0in}{2.8in}{\includegraphics{images/FertRates.png}}}
  \end{figure}

  \begin{figure}[htbp]\centering \captionsetup{width=4.0in}
    \caption{\label{FigMortRates}\textbf{Mortality rates $\rho_s$ for $S=60$}}
    \fbox{\resizebox{4.0in}{2.8in}{\includegraphics{images/MortRates.png}}}
  \end{figure}

  \begin{figure}[htbp]\centering \captionsetup{width=4.0in}
    \caption{\label{FigImmigRates}\textbf{Immigration rates $i_s$ for $S=60$}}
    \fbox{\resizebox{4.0in}{2.8in}{\includegraphics{images/ImmigRates.png}}}
  \end{figure}
  ...
  \begin{figure}[htbp]\centering \captionsetup{width=4.0in}
    ...
    \fbox{\resizebox{4.0in}{2.8in}{\includegraphics{images/PopPath.png}}}
  \end{figure}

  \begin{figure}[htbp]\centering \captionsetup{width=4.0in}
    \caption{\label{FigSSpopdist}\textbf{Steady-state population percent distribution by age $\bm{\bar{\omega}}$}}
    \fbox{\resizebox{4.0in}{2.8in}{\includegraphics{images/SSpopdist.png}}}
  \end{figure}
  \clearpage
