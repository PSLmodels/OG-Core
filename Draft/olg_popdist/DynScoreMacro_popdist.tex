...
\section{Model with Endogenous Labor}\label{SecModel}
  ...
  \subsection{Individual problem}\label{SecIndProb}
    ...
    \begin{equation}\label{EqBC1}
      c_{j,s,t} + b_{j,s+1,t+1} \leq w_t e_{j,s}n_{j,s,t} + \frac{\omega_{s,t}}{N_t}BQ_{j,t} \quad \text{for} \quad s = E+1 \quad \forall j,t
    \end{equation}
    \begin{equation}\label{EqBC2}
      \begin{split}
        c_{j,s,t} + b_{j,s+1,t+1} &\leq \left(1 + r_t\right) b_{j,s,t} + w_t e_{j,s}n_{j,s,t} + \frac{\omega_{s,t}}{N_t}BQ_{j,t} \\
        &\quad\quad\quad \text{for} \quad E+2\leq s \leq E+S-1 \quad \forall j,t
      \end{split}
    \end{equation}
    \begin{equation}\label{EqBC3}
      c_{j,s,t} + bq_{j,s+1,t+1} \leq \left(1 + r_t\right) b_{j,s,t} + w_t e_{j,s}n_{j,s,t} + \frac{\omega_{s,t}}{N_t}BQ_{j,t} \quad \text{for} \quad s = E+S \quad \forall j,t
    \end{equation}
    ...
    \begin{equation}\label{EqSmaxprob}
      \footnotesize{\begin{split}
        ...
        &\text{s.t.} \quad c_{j,E+S,t} = \left(1 + r_t\right) b_{j,E+S,t} + w_t e_{j,E+S}n_{j,E+S,t} + \frac{\omega_{E+S,t}}{N_t}BQ_{j,t} - bq_{j,E+S+1,t+1} \quad \forall j,t
      \end{split}}
    \end{equation}
    ...
    \small{\begin{gather}
      c_{j,E+S,t} = \left(1 + r_t\right) b_{j,E+S,t} + w_t e_{j,E+S}n_{j,E+S,t} + \frac{\omega_{E+S,t}}{N_t}BQ_{j,t} - bq_{j,E+S+1,t+1} \quad \forall j,t \label{EqScons} \\
    ...
    \begin{equation}\label{EqEulerSm1lab}
      \begin{split}
        ...
        &\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \frac{\omega_{E+S-1,t}}{N_t}BQ_{j,t} - b_{j,E+S,t+1}
      \end{split}
    \end{equation}
    ...
    \begin{equation}\label{EqEulerSlab2}
      \begin{split}
        ...
        &\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \frac{\omega_{E+S,t+1}}{N_{t+1}}BQ_{j,t+1} - bq_{j,E+S+1,t+2}
      \end{split}
    \end{equation}
    ...
    \begin{equation}\label{EqEulerLabGen}
      \begin{split}
        ...
        &\quad\text{where}\quad c_{j,s,t} = \left(1+r_t\right)b_{j,s,t} + w_t e_{j,s}n_{j,s,t} + \frac{\omega_{s,t}}{N_t}BQ_{j,t} - b_{j,s+1,t+1} \\
        &\quad\quad\quad\quad\quad\quad\quad\quad\quad\text{for}\quad E+1\leq s\leq E+S-1 \\
        &\quad\quad\text{and}\quad c_{j,s,t} = \left(1+r_t\right)b_{j,s,t} + w_t e_{j,s}n_{j,s,t} + \frac{\omega_{s,t}}{N_t}BQ_{j,t} - bq_{j,s+1,t+1} \\
