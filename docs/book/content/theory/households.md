...
<figure class="image"><img src="./images/EllipVsCFE_MargUtil.png" alt="CFE vs elliptical utility"><figcaption>Comparison of CFE marginal disutility of leisure $\theta=0.9$ to fitted elliptical utility</figcaption></figure>
