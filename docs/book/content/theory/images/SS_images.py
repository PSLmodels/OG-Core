...
ax.plot_surface(smat, jmat, cssmat.T, rstride=strideval,
...
strideval = max(int(1), int(round(S / 10)))
ax.plot_surface(smat, jmat, nssmat.T, rstride=strideval,
                cstride=strideval, cmap=cmap_c)
...
strideval = max(int(1), int(round(S / 10)))
ax.plot_surface(smat_s, jmat, bssmat_s.T, rstride=strideval,
                cstride=strideval, cmap=cmap_c)
