...
\begin{frame}
\frametitle{Philosophy behind OSPC's dynamics scoring model}
\begin{itemize}
\item Transparency
\item Freely available and useful
	\begin{itemize}
	\item To policy community experts
	\item To academics
	\item To others through web interface
	\end{itemize}
\item Open dialogue about this class of model
\end{itemize}
\end{frame}
