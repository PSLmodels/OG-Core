...
\begin{equation}
\label{eqn:r_firm_i}
r_{i,t} = \frac{DIV_{it} + \underbrace{V_{i,t+1}-V_{i,t}-VN_{i,t}}_{\text{capital gains}}}{V_{i,t}}, 
\end{equation}
...
Firms are competitive and so take the prices of output and capital as given.  Unlike the static firm model, there is not a per period zero profit condition.  The analogous condition for the dynamic firm's problem is that prices are such that the return to the firm's shareholders is the market rate of return.
