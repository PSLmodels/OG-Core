...
\begin{split}
 ...
 & +  \prod_{\nu=t}^{u+1} \left(\frac{1}{1+\frac{r_{\nu}}{(1-\tau^{g}_{m,\nu})}}\right) \left\{ \left(\frac{1-\tau^{d}_{m,u+1}}{1-\tau^{g}_{m,u+1}}+\lambda^{d}_{m,u+1}\right)\tau^{b}_{m,u+1}\delta^{\tau}_{m,u+1} \right\} \\
\implies \lambda^{\tau}_{m,u} &=  \left(\frac{1}{1+\frac{r_{u+1}}{(1-\tau^{g}_{m,u+1})}}\right) \left[ \left(\frac{1-\tau^{d}_{m,u+1}}{1-\tau^{g}_{m,u+1}}+\lambda^{d}_{m,u+1}\right)\tau^{b}_{m,u+1}\delta^{\tau}_{m,u+1} \right]  \\
\end{split}
\end{equation}
...
Using Equations \ref{eqn:lagrange_foc_i_tax} and \ref{eqn:lagrange_foc_ktau_tax}, we can solve for marginal q as a function of the price of capital, taxes, and the Lagrangian multiplier on the dividends non-negativity constraint.  We end up with:
...
\label{eqn:lagrange_foc_ktau_tax}
\begin{split}
\bar{\lambda}^{\tau}_{m} &=  \left(\frac{1}{1+\frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}}\right) \left[ \left(\frac{1-\bar{\tau}^{d}_{m}}{1-\bar{\tau}^{g}_{m}}\right)\bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m} \right]  \\
\end{split}
\end{equation}
...
\label{eqn:lagrange_foc_vn_tax2}
\begin{split}
  \lambda^{v}_{m,u} = 1 - \left(\frac{1-\bar{\tau}^{d}_{m}}{1-\bar{\tau}^{g}_{m}}\right)   \\
\end{split}
\end{equation}
...
\bar{K}_{m} = \bar{A}_{m}^{\epsilon_{m}-1}\gamma_{m}\bar{X}_{m}\left(\frac{\bar{p}^{k}_{m}}{\bar{p}}\left(\frac{\bar{r}}{1-\bar{\tau}^{g}_{m}}+\delta_{m}\right)\left(1-\left(\frac{1-\bar{\delta}^{\tau}}{1-\bar{\tau}^{g}_{m}}\right)\bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m}\right)\right)^{-\epsilon_{m}}
\end{equation}
...
\implies &  \bar{r} \bar{p}^{k}_{m}\left[\left(\frac{1-\bar{\tau}^{d}_{m}}{1-\bar{\tau}^{g}_{m}}\right) - (1-\bar{\delta}^{\tau}_{m}) \left(\frac{1}{1+\frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}}\right) \left[ \left(\frac{1-\bar{\tau}^{d}_{m}}{1-\bar{\tau}^{g}_{m}}\right)\bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m} \right] \right]\bar{K}_{m}  =  \\
& \quad\quad\quad\quad\quad (1-\bar{\tau}^{d}_{m})\left[(1-\bar{\tau}^{b}_{m})\left(\bar{p}_{m}\bar{X}_{m} - \bar{w}\overline{EL}_{m}\right) - (1-\bar{\tau}^{b}_{m}(1-\bar{\delta}^{\tau}_{m}))\delta_{m}\bar{p}^{k}_{m}\bar{K}_{m}\right] \\
\implies &  \frac{\bar{r} \bar{p}^{k}_{m}}{1-\bar{\tau}^{g}_{m}}\left[1 - \left(\frac{1-\bar{\delta}^{\tau}_{m}}{1+\frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}}\right) \left[ \bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m} \right] \right]\bar{K}_{m}  =  \\
& \quad\quad\quad\quad\quad \left[(1-\bar{\tau}^{b}_{m})\left(\bar{p}_{m}\bar{X}_{m} - \bar{w}\overline{EL}_{m}\right) - (1-\bar{\tau}^{b}_{m}(1-\bar{\delta}^{\tau}_{m}))\delta_{m}\bar{p}^{k}_{m}\bar{K}_{m}\right] \\
\implies & (1-\bar{\tau}^{b}_{m})\left(\bar{p}_{m}\bar{X}_{m} - \bar{w}\overline{EL}_{m}\right)   =  \\
& \quad\quad\quad\quad\quad   \frac{\bar{r} \bar{p}^{k}_{m}}{1-\bar{\tau}^{g}_{m}}\left[1 - \left(\frac{1-\bar{\delta}^{\tau}_{m}}{1+\frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}}\right) \left[ \bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m} \right] \right]\bar{K}_{m}+ (1-\bar{\tau}^{b}_{m}(1-\bar{\delta}^{\tau}_{m}))\delta_{m}\bar{p}^{k}_{m}\bar{K}_{m} \\
\implies & \bar{p}_{m}\bar{X}_{m}   =  \\
& \quad\quad   \left[ \frac{\bar{r} \bar{p}^{k}_{m}}{(1-\bar{\tau}^{g}_{m})(1-\bar{\tau}^{b}_{m})}\left[1 - \left(\frac{1-\bar{\delta}^{\tau}_{m}}{1+\frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}}\right) \left[ \bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m} \right] \right]+ \frac{(1-\bar{\tau}^{b}_{m}(1-\bar{\delta}^{\tau}_{m}))}{(1-\bar{\tau}^{b}_{m})}\delta_{m}\bar{p}^{k}_{m}\right]\bar{K}_{m} + \bar{w}\overline{EL}_{m} \\
\implies & \bar{p}_{m}   =  \\
& \quad\quad  \frac{\bar{p}^{k}_{m}}{(1-\bar{\tau}^{b}_{m})} \left[ \frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}\left[1 - \left(\frac{1-\bar{\delta}^{\tau}_{m}}{1+\frac{\bar{r}}{(1-\bar{\tau}^{g}_{m})}}\right) \left[ \bar{\tau}^{b}_{m}\bar{\delta}^{\tau}_{m} \right] \right]+ (1-\bar{\tau}^{b}_{m}(1-\bar{\delta}^{\tau}_{m}))\delta_{m}\right]\frac{\bar{K}_{m}}{\bar{X}_{m}} + \bar{w}\frac{\overline{EL}_{m}}{\bar{X}_{m}} \\
\end{split}
\end{equation}
