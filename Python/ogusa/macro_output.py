...
output_dir = "./OUTPUT"
#TPI_macro_vars_policy = pickle.load( open(os.path.join(os.path.join(os.path.join(output_dir,"Gale_Output_12012015"), "TPI"), "TPI_macro_vars.pkl"), "rb" ) )
TPI_macro_vars_policy = pickle.load( open( "/Users/jasondebacker/repos/dynamic/Python/OUTPUT/Gale_Output_12012015/TPI/TPI_macro_vars.pkl", "rb" ) )
#TPI_macro_vars_baseline = pickle.load( open( "./OUTPUT/TPI/TPI_macro_vars.pkl", "rb" ) )
TPI_macro_vars_baseline = pickle.load( open( "/Users/jasondebacker/repos/dynamic/Python/OUTPUT/TPI/TPI_macro_vars.pkl", "rb" ) )
