...
plt.savefig('Saved_moments/gini_wealth.png')
...
plt.ylabel('Gini Coefficient')
plt.title('Gini coefficient for inequality across age and ability')
plt.savefig('Saved_moments/gini_income.png')
...
plt.ylabel('Gini Coefficient')
plt.title('Gini coefficient for inequality across age and ability')
plt.savefig('Saved_moments/gini_cons.png')
...
plt.ylabel('Gini Coefficient')
plt.title('Gini coefficient for inequality across age and ability')
plt.savefig('Saved_moments/gini_lab.png')