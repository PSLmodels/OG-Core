...
def create_steady_state_parameters(a_tax_income, b_tax_income, c_tax_income,
                                  ...
                                  mean_income_data, get_baseline, **kwargs):
    ...
    parameters = ([J, S, T, beta, sigma, alpha, Z, delta, ltilde, nu, g_y,
                  tau_payroll, retire, mean_income_data] + income_tax_params
...
def Euler_equation_solver(guesses, r, w, T_H, factor, j, params, chi_b, chi_n,
    ...
    """
       This is the function passed to scipy.opt.fsolve.
    """
    J, S, T, beta, sigma, alpha, Z, delta, ltilde, nu, g_y, tau_payroll,\
        retire, mean_income_data, a_tax_income, b_tax_income, c_tax_income, \
        d_tax_income, h_wealth, p_wealth, m_wealth, b_ellipse, upsilon = params
...
def SS_solver(b_guess_init, n_guess_init, wguess, rguess, T_Hguess, factorguess, chi_n, chi_b, params, iterative_params, tau_bq, rho, lambdas, weights, e):
    ...
    while (dist > mindist_SS) and (iteration < maxiter):
        ...
        K = household.get_K(bssmat, weights)
...
def run_steady_state(ss_parameters, iterative_params, get_baseline=False):
    ...
    Kss = household.get_K(bssmat_splus1, omega_SS)
