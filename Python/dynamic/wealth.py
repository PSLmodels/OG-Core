...
#data = pd.read_table(os.path.join(WEALTH_DIR, "scf2007to2013_wealth_age_all_percentiles.csv"),
                     #sep=',', header=0)
wealth_file = utils.read_file(cur_path, "data/wealth/scf2007to2013_wealth_age_all_percentiles.csv")
...
def wealth_data_graphs(output_dir):
    ...
    plt.savefig(os.path.join(outputdir, '/Demographics/distribution_of_wealth_data'))
    ...
    plt.savefig(os.path.join(outputdir, '/Demographics/distribution_of_wealth_data_log'))
