...
if get_baseline:
    ...
    rguess = .061828
    T_Hguess = 0.036225
    factorguess = 179322.5
    solutions = SS_solver(b_guess.reshape(S, J), n_guess.reshape(S, J), wguess*1.0, rguess*1.0, T_Hguess*1.0, factorguess*1.0, chi_params[J:], chi_params[:J], parameters, iterative_params, tau_bq, rho, lambdas, omega_SS, e)
