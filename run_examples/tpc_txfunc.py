...
'''
------------------------------------------------------------------------
This script reads in data generated from the TPC microsimulation model.
...
import pickle
import read_TPC_microdata as get_micro_data
...
def txfunc_est(df, s, t, rate_type, tax_func_type, numparams,
    ...
    if tax_func_type == 'DEP':
        ...
        # tax functions.
        # '''
        Atil_init = 4.74811617e-13
        Btil_init = 2.79311528e+00
        Ctil_init = 1.13411477e+00
        Dtil_init = 2.3
        # Atil_init = 1.0
        # Btil_init = 1.0
        # Ctil_init = 1.0
        ...
        # '''
        phi0_init = 0.43116036
        phi1_init = 0.33273013
        phi2_init = 0.00537725
...
def tax_func_estimate(BW, S, starting_age, ending_age,
    ...
    micro_data, taxcalc_version = get_micro_data.get_data(
        baseline=baseline, start_year=start_year, end_year=end_yr,
        path=data)
