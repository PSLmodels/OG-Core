...
def test_total_taxes():
    ...
    p.etr_params = np.array([[0.001, 0.002, 0.003, 0.0015, 0.8, -0.14, 0.8,
                           -0.15, 0.15, 0.16, -0.15, 0.83],
    ...
    p.S = 3
    p.T = 3
    p.etr_params = np.tile(np.reshape(np.array([[0.001, 0.002, 0.003, 0.0015, 0.8, -0.14, 0.8,
                           -0.15, 0.15, 0.16, -0.15, 0.83],
                           [0.001, 0.002, 0.003, 0.0015, 0.8, -0.14, 0.8,
                            -0.15, 0.15, 0.16, -0.15, 0.83],
                           [0.001, 0.002, 0.003, 0.0015, 0.8, -0.14, 0.8,
    ...
    p.tau_bq =  np.array([0.1])#np.array([0.1, 0.12])
    p.retire = 2
    j = None
    shift = True
    total_taxes = tax.total_taxes(r, w, b, n, BQ,
                                  factor, T_H, theta, j, shift, method, p)
    print('test results = ', total_taxes)
    print('True results = ', np.array([[[0.16311573, 0.1783638],
